...
# userage =
# userInput = input("what year were your born?")
# if userInput
...
# userInput = input("Enter some peoples names")
# if userInput == "Kevin":
#     print("Hello Teacher")
# else:
#     print("Hello Student")
...
# for userInput in range(7, userInput - 1, -1):
#     print(userInput)


# Problem 4:
# Ask the user to enter a number between -10 to -5.
# If their input is not between the two numbers ask them to do it
# again until they get it right. Afterward they print the correct number, print "Good job"
